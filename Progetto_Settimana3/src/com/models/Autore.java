...
@NamedQuery(name = "searchByISBN", query = "SELECT pc FROM Autore pc WHERE pc.isbn = :isbn")
...
public class Autore {
	...
	public Autore(String titolo, Integer annoPubblicazione, Integer pagine) {
		super();
		this.titolo = titolo;
	...
	public String toString() {
		return "Autore [isbn=" + isbn + ", titolo=" + titolo + 
